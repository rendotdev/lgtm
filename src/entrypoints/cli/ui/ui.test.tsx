...
import { CommandUiComponent, CommandUiRendererServiceBuilder } from "./ui.tsx";

afterEach(cleanup);

describe("CommandUiRendererService", () => {
  ...
  it("renders loading and completed integration states", () => {
    const view = render(<CommandUiComponent state="loading" label="Updating lgtm integrations" />);
