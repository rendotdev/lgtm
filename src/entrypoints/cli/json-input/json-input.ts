...
export const { JsonReviewInputSingleton, JsonReviewInputSingletonBuilder } = build().singleton(
  "JsonReviewInputSingleton",
  {
    build() {
      function parse(params: { value: unknown }): JsonReviewInput {
...
export const { ReviewGroupsInputSingleton, ReviewGroupsInputSingletonBuilder } = build().singleton(
  "ReviewGroupsInputSingleton",
  {
    build() {
      function parse(params: { value: unknown }): ReviewGroupInput[] {
