...
import type { ReviewGroup, ReviewSourceFile } from "../../modules/review/review/review.ts";

export const { ReviewGroupPresentationSingleton, ReviewGroupPresentationSingletonBuilder } =
  build().singleton("ReviewGroupPresentationSingleton", {
    build() {
