...
import { ReviewCommentInteractionServiceBuilder } from "./review-comment-interaction.ts";

function interaction(params: { runTimeout?: boolean; timeoutCallbacks?: Array<() => void> } = {}) {
  return ReviewCommentInteractionServiceBuilder({
    config: {
...
describe("ReviewCommentInteractionService", () => {
  ...
  it("restores the selected diff line after a virtualized layout change", () => {
    ...
    const line = {
      ...
      getBoundingClientRect: () => ({ top: lineTop }),
