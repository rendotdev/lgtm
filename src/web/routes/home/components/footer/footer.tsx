...
function HomeFooterView(props: HomeFooterProps) {
  const reviewPathInputWidthInCharacters = Math.max(20, props.displayedReviewPath.length + 12);
        ...
        >
          ...
          >
            <InputGroup.Input
              ...
              style={{ width: `${reviewPathInputWidthInCharacters}ch` }}
...
export const { HomeFooterComponent, HomeFooterComponentBuilder } = build().component(
  "HomeFooterComponent",
  HomeFooterView,
);
