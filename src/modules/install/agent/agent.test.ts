...
import {
  AgentInstallCommandServiceBuilder,
  AgentInstallerServiceBuilder,
  AgentUpdaterServiceBuilder,
} from "./agent.ts";

describe("AgentInstallCommandService", () => {
  it("captures successful integration output", async () => {
    const Runner = AgentInstallCommandServiceBuilder({ config: {}, deps: { spawn } });
...
describe("AgentInstallerService", () => {
  it("runs each planned command in order", async () => {
    ...
    const Installer = AgentInstallerServiceBuilder({ config: {}, deps: { runCommand } });
...
describe("AgentUpdaterService", () => {
  it("runs the update plan through the command runner", async () => {
    ...
    const Updater = AgentUpdaterServiceBuilder({ config: {}, deps: { runCommand, readCommand } });
