...
import { ReviewExpirationServiceBuilder } from "./expiration.ts";

describe("ReviewExpirationService", () => {
  it("schedules expiration at the persisted deadline", async () => {
    ...
    const Scheduler = ReviewExpirationServiceBuilder({
      config: { expiresAt: "2026-07-20T20:00:00.000Z" },
      deps: {
