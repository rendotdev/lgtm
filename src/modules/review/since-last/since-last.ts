...
import type { DiffReviewFileInput } from "../review/review.ts";

export const { ReviewSinceLastSingleton, ReviewSinceLastSingletonBuilder } = build().singleton(
  "ReviewSinceLastSingleton",
  {
    build() {
